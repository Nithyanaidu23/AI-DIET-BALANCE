  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold font-display text-white">User Management</h1>
      ...
      <div className="card flex flex-col sm:flex-row gap-3 sm:gap-4">
        ...
        <select
          ...
          className="select text-sm py-2 w-full sm:w-44"
        >
              ...
              {list.map((u) => (
                <tr key={u.id} className="hover:bg-slate-800/30">
                  <td className="py-3 px-4">
                    ...
                    <p className="text-slate-500 text-[11px] truncate max-w-[200px]">{u.email}</p>
                  </td>
                  <td className="py-3 px-4">
                  ...
                  <td className="py-3 px-4 text-right space-x-2">
                    {u.role !== 'admin' ? (
                      <button
                        ...
                        className="btn-secondary py-1 px-2.5 text-[11px] gap-1 inline-flex"
                      >
                      ...
                      <button
                        ...
                        className="btn-secondary py-1 px-2.5 text-[11px] inline-flex"
                      >
                        Demote to User
                      </button>
                    )}
                    ...
                    <button
                      ...
                      className={`btn-ghost py-1 px-2.5 text-[11px] inline-flex ${u.is_active ? 'text-red-400 hover:bg-red-500/10' : 'text-emerald-400'}`}
                    >
